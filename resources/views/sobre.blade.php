...
@section('content')
        ...
        <h1 class="titulo-card">Materias que pode ser reciclados.</h1>
        <p class="p-card"><span class="span_texto">O</span> ideal é que esses itens sejam devolvidos às lojas ou fabricantes, que os encaminharão para um local que realiza a reciclagem do lixo eletrônico. Se o fabricante não oferecer essa opção, você pode procurar por alguma cooperativa local que faça o mesmo processo.</p>
        <div id="carouselExampleControls" class="carousel slide carrosel" data-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
            <div class="card-body coisa">
